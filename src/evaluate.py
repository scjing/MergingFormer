...
def evaluate_model(model, test_loader, configs, save_path):
    ...
    eval_file = os.path.join(save_path, 'evaluation_results_old.txt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_name', type=str,
                        default="enc_in_23_d_model_128_d_ff_1024_ep_30_e_layers_6_d_layers_6_embed_32",
    ...
    class Config:
        def __init__(self):
            ...
            self.factor = 4
            self.n_heads = 8
            self.e_layers = 6  # todo
            self.d_layers = 6  # todo
            self.d_ff = 1024
