...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Evaluate the Autoformer model and visualize results.")
    ...
    parser.add_argument('--config_name', type=str,
                        default="db_autoformer_enc_in_23_d_model_256_d_ff_1024_ep_18_e_layers_6_d_layers_6_embed_256_lr_0.001",
