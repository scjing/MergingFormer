...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Evaluate the Performer model and visualize results.")
    ...
    parser.add_argument('--config_name', type=str,
                        default="db_Performer_enc_in_23_d_model_128_dim_ff_2048_ep_15_enc_layers_3_dec_layers_3_lr_0.001",
    ...
    from models.Model_Performer import Model_Performer

    model = Model_Performer(configs)
