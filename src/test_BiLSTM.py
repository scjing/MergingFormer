...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Evaluate the BiLSTM model and visualize results.")
    ...
    parser.add_argument('--config_name', type=str,
                        default="xr_BiLSTM_enc_in_15_d_model_128_d_ff_1024_ep_100_e_layers_6_d_layers_6_embed_64_lr_0.001map21024",
    ...
    from models.Model_BiLSTM import Model_BiLSTM

    model = Model_BiLSTM(configs)
