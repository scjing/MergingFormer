...
from models.Model_LSTM_ASSA import Model_LSTM_ASSA
...
def train():
    ...
    param_info = f"xr_LSTM_ASSA_enc_in_{configs.enc_in}_d_model_{configs.d_model}_d_ff_{configs.d_ff}_ep_{num_epochs}_e_layers_{configs.e_layers}_d_layers_{configs.d_layers}_embed_{configs.embed}_lr_{learning_rate}"
    ...
    for epoch in range(num_epochs):
        ...
        print(f"Epoch {epoch+1}/{num_epochs}, Train Loss: {train_loss_avg:.12f}, Val Loss: {val_loss_avg:.12f}")
