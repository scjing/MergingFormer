...
def train():
    ...
    param_info = (
        f"db_Performer_enc_in_{configs.enc_in}_d_model_{configs.d_model}_dim_ff_{configs.dim_feedforward}_ep_{num_epochs}_"
        f"enc_layers_{configs.num_encoder_layers}_dec_layers_{configs.num_decoder_layers}_lr_{learning_rate}"
    )
