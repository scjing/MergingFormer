...
from models.db_informer import Model_Informer
...
def train_informer():
    ...
    param_info = (
        f"db_informer_enc_in_{configs.enc_in}_d_model_{configs.d_model}_d_ff_{configs.d_ff}_ep_{num_epochs}_"
