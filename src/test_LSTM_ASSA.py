...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Evaluate the LSTM+ASSA model and visualize results.")
    ...
    parser.add_argument('--config_name', type=str,
                        default="xr_LSTM_ASSA_enc_in_23_d_model_128_d_ff_1024_ep_28_e_layers_6_d_layers_6_embed_64_lr_0.01",
