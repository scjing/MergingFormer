...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Evaluate the Transformer+ASSA model and visualize results.")
    ...
    parser.add_argument('--config_name', type=str, default="xr_Transformer_ASSA_enc_in_23_d_model_128_d_ff_1024_ep_30_e_layers_6_d_layers_6_embed_64_lr_0.0001",
